...
<body>
    ...
    <div class="container mt-5">
        <form id="searchForm" class="input-group mb-3">
            <input type="text" class="form-control" id="query" name="query" placeholder="Pesquisar Funcionarios...">
            ...
            <table id="originalTable" class="table table-hover text-center">
                <thead class="table-primary">
                    <tr>
                        ...
                        <th scope="col">
                            <a href="add_fun.php" class="btn-new mb-3"><i>Novo Funcionário</i></a>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            $prospeccao = date('d/m/Y', strtotime($row['prospeccao']));
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($telefoneFormatado); ?></td>
                        ...
                        <td><?php echo htmlspecialchars($prospeccao); ?></td>
                        <td>
                            <a href="edit_fun.php?id=<?php echo urlencode($row['Id']); ?>"
                                class="btn btn-warning">EDITAR</a>
                            <form class="d-inline delete-form" method="post" action="delet_fun.php">
                    ...
                    <?php
                        ...
                        echo "<tr><td colspan='12' class='text-center no-results'>Nenhum Funcionário encontrado.</td></tr>";
                    }
    ...
    document.getElementById('searchForm').addEventListener('submit', function(event) {
        ...
        xhr.open('GET', 'search_fun.php?query=' + encodeURIComponent(query), true);
