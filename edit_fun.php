...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `funcionarios` SET `nome`='$nome',`telefone`='$telefone',`cpf`='$cpf',`endereco`='$endereço',`cargo`='$cargo',`pagamento`='$pagamento',`nascimento`='$nascimento',`prospeccao`='$prospeccao' WHERE `id`='$Id'";
...
<body>
    ...
    <div class="container">
        <div class="text-center mb-4">
            ...
            <p class="text-muted">
                Clique no botão "Atualizar" para editar as informações do seu Funcionário
            </p>
        </div>
        ...
        <div class="container d-flex justify-content-center">
            <form action="" method="post" style="width: 50vw; min-width:300px;">
                <div class="row mb-3">
                    ...
                    <div class="col">
                        <label class="form-label">Cargo do Funcionário:</label>
                        <input type="text" class="form-control" name="cargo"
                            value="<?php echo htmlspecialchars($row['cargo']); ?>">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Pagamento Mensal do Funcionário:</label>
                        <input type="text" class="form-control" name="pagamento"
                            value="<?php echo htmlspecialchars($row['pagamento']); ?>">
                    </div>
                    <div class="mb-3">
